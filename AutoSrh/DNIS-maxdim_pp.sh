...
python -u main_nas.py --cuda 1 --data_path data/ml-20m/ratings.csv --exp DNIS-CF-dim512 --dataset_type cf --embedding_dim 512 --init_alpha 1.0 --warm_start_epochs 20 \
...
python -u main_nas.py --cuda 1 --data_path data/ml-20m/ratings.csv --exp DNIS-CF-dim1024 --dataset_type cf --embedding_dim 1024 --init_alpha 1.0 --warm_start_epochs 20 \
